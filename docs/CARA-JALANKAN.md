...
4. Tunggu setup otomatis (Docker + dataset Excel **30 event**) — bisa 3–8 menit pertama kali  
...
Event: **30 konser** (`/?event=1` … `/?event=30`)  
Contoh: `1` TREASURE · `2` LYKN · `3` BLACKPINK · `11` 4EVE · `12` IU · `30` KATSEYE  
Daftar penuh: `data/events.manual.json` / `data/data-summary.json`
...
5. Web war tiket (30 event Excel) siap
